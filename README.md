...
- 기초 과정(분수 · 소수 · 비와 비율)에서 시작해 중학교 과정과 고등학교 1학년으로 이어지는 **코스 29개, 수업 90개** — 고등학교 1학년까지 이었고, **중학교 1학년 과정을 온전히 채웠으며**, 중2의 도형(삼각형과 사각형의 성질 · 닮음)까지 메웠고, 남은 빈 곳(중2 피타고라스 정리 · 확률, 중3 삼각비 · 원의 성질 · 대푯값과 산포도)을 메우는 중
...
- 시작점 확인 문항 281개가 카탈로그의 개념 141개를 개념마다 둘씩 묻습니다. 은행이 두 배가 되어도 한 사람이 받는 문항 수는 늘지 않습니다

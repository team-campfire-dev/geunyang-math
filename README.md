...
- 학교 줄기 옆에 **NCS 수리영역 코스 4개, 수업 20개** — 기초연산·기초통계·도표분석·도표작성 네 영역에 일률 · 이자 · 환율 · 확률 · 그래프 읽기 · 조건 걸어 고르기까지
...
- 시작점 확인 문항 325개가 카탈로그의 개념 163개를 개념마다 둘씩 묻습니다. 은행이 두 배가 되어도 한 사람이 받는 문항 수는 늘지 않습니다

...
성인이 기초부터 자신의 속도로 수학을 다시 배우는 웹 서비스입니다. 기본 수업과 학습 기록, 과제 배정·제출을 먼저 만들고, 이후 수업 편집기와 AI 맞춤 수업 작성으로 확장합니다.
...
- 분수의 의미, 동치분수·약분, 분수의 덧셈을 다루는 기본 수업 3개
...
진단·첫 풀이·선행개념에 따른 규칙 기반 추천과 시간에 맞춘 새 복습 과제를 제공합니다. 수업·진단 문항·개념·용어는 DB에서 읽으며, `/authoring` 화면이나 [콘텐츠 관리 명령](docs/content-management.md)으로 새 판본을 발행합니다. 화면에 아직 없는 것은 진단 편집·숙제 문항 편집·일반 이미지이고, AI 호출은 없습니다.
...
공개 DTO에 정답·채점 규칙·비공개 해설을 포함하지 않습니다. 정답은 서버 전용 수업 문서와 과제 문항 snapshot에 보관합니다. 웹·모바일은 같은 HTTP 계약을 사용하며, 기관·반·교사 권한은 후속 단계에서 개인 scope와 구분해 구현합니다.

...
describe('the placement bank', () => {
  ...
  it('leaves every earlier bank published exactly as it was', () => {
    ...
    expect(versions.map((item) => item.versionId)).toEqual(['placement-v4', 'placement-v5', 'placement-v6', 'placement-v7', 'placement-v8', 'placement-v9', 'placement-v10', 'placement-v11', 'placement-v12', 'placement-v13', 'placement-v14', 'placement-v15', 'placement-v16', 'placement-v17']);
  });

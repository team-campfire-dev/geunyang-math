...
function ProblemCard({ problem, attempt, context, contextId, dispatch, busy, disabled, onLogin, onDraftChange, glossary }: {
  problem: PublicProblem; attempt?: AttemptView | null; context: 'class' | 'assignment'; contextId?: string; dispatch: Dispatch; busy: boolean; disabled?: boolean; onLogin: () => void; onDraftChange?: (id: string, dirty: boolean) => void; glossary?: GlossaryContext;
}) {
